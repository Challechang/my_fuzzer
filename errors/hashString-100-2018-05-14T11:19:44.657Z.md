...
## Usage
Simply, run the FuzzerDriver.java program to test the files providet or use the Fuzzer.java program wit> the following command: java Fuzzer [file location] [fuzz fa4toy] [iterations]
